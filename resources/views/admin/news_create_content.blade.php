<div class="card-box">
    ...
    <form action="{{ route('news.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <textarea name="text" class="form-control" id="description" cols="30" rows="5" placeholder="">{{ old('text') }}</textarea>
        </div>
        <div class="form-group">
            <label for="keywords">Keywords<span class="text-danger">*</span></label>
            <input type="text" name="keywords" placeholder="Keywords" class="form-control" id="keywords" value="{{ old('keywords') }}">
        </div>
        <div class="form-group">
            <label for="meta_description">Description<span class="text-danger">*</span></label>
            <input type="text" name="description" placeholder="Description" class="form-control" id="meta_description" value="{{ old('description') }}">
        </div>
        <div class="form-group">
