<div id="app">
    <div class="row">
        <div class="col-md-12 mb-4">
            ...
            <a class="btn btn-outline-dark waves-light waves-effect btn-sm" href="{{ route('forecasters.index') }}"><i class="fa fa-user-circle-o"></i> Прогнозисты</a>
            <a class="btn btn-outline-dark waves-light waves-effect btn-sm active" href="{{ route('users.index') }}"><i class="fa fa-users"></i> Пользователи</a>
        </div>
