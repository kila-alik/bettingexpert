  ...
  <div id="content" class="container_14">
    ...
    <style type="text/css" media="screen">
        @font-face {
            ...
            src: url('<?php echo e(env('THEME')); ?>/fonts/GothaProBol.eot');
            src: local('@'), url('<?php echo e(env('THEME')); ?>/fonts/GothaProBol.woff') format('woff'), url('<?php echo e(env('THEME')); ?>/fonts/GothaProBol.ttf') format('truetype'), url('<?php echo e(env('THEME')); ?>/fonts/GothaProBol.svg') format('svg');
            font-weight: normal;
            font-style: normal;
        }
    </style>
