<div id="app">
    <div class="row">
        <div class="col-md-12 mb-4">
            ...
            <a class="btn btn-outline-dark waves-light waves-effect btn-sm active" href="<?php echo e(route('forecasters.index')); ?>"><i class="fa fa-user-circle-o"></i> Прогнозисты</a>
            <a class="btn btn-outline-dark waves-light waves-effect btn-sm" href="<?php echo e(route('users.index')); ?>"><i class="fa fa-users"></i> Пользователи</a>
        </div>
                ...
                <div class="text-center card-box">
                    ...
                    <div class="member-card pt-2 pb-2">
                        ...
                        <div class="mt-4">
                            ...
                            <?php echo e(str_limit($user->information, 15)); ?>
